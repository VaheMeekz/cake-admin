...
import {getHomeFooterThunk} from "../../store/actiions/footerAction";
        ...
        <Box m={2}>
            ...
            <Box>
                <Box sx={{width: '100%'}}>
                    ...
                    <Button style={{margin:"20px"}} variant="contained" onClick={handleChangeFooterTexts}>Submit</Button>
                    <Box m={2}>
                        <img src={image} width={300}/>
                        <Button style={{margin:"-15px 0 20px 20px" }} onClick={() => setOPen(true)} variant="contained">Edit</Button>
                    </Box>
                </Box>
            </Box>
            <Modal
